      ...
      <div className="relative">
        ...
        {toggleMenu && (
          <div className="md:hidden absolute border border-gray-300 top-8 right-6 bg-white flex flex-col items-start justify-start w-[264px] px-4 py-6 rounded-lg">
              <h1 className="text-[#12aef5] font-bold px-7 py-2 text-xl">Hi {userData.name}</h1>
            ...
            <Link to="/login">
            <button onClick={handleLogout} className="hover:opacity-80 transition-all duration-400 text-white cursor-pointer bg-[#12aef5] w-full px-10 py-2 rounded-md text-lg">
              Logout
            </button>
          </Link>
            </div>
